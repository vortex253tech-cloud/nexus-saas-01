    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-zinc-950 px-4">
      ...
      >
        ...
        <div className="relative flex h-20 w-20 items-center justify-center">
          ...
          <div className="relative flex h-14 w-14 items-center justify-center rounded-2xl bg-violet-600 shadow-[0_0_32px_rgba(37,99,235,0.5)]">
      ...
      <div className="relative z-10 mx-auto max-w-4xl px-4 md:px-8">
        ...
        >
          ...
          <div className="relative">
            ...
            <Link
              href="/planos"
              className="group relative inline-flex items-center gap-3 overflow-hidden rounded-xl bg-violet-600 px-8 py-4 text-base font-bold text-white shadow-[0_0_40px_rgba(37,99,235,0.4)] transition-all hover:bg-violet-500 hover:shadow-[0_0_56px_rgba(37,99,235,0.55)] active:scale-[0.98]"
            >
