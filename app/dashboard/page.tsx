  ...
  return (
    <div className="min-h-screen bg-zinc-950">
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-5 sm:px-6 py-6 space-y-6">
        ...
        <Link
          href="/dashboard/nexus"
          className="flex items-center justify-between gap-3 rounded-xl border border-violet-500/20 bg-gradient-to-r from-violet-950/50 to-slate-900/30 px-4 py-2.5 hover:border-violet-500/40 transition-all duration-200 group"
        >
          <div className="flex items-center gap-3">
            <div className="relative w-7 h-7 shrink-0">
              ...
              />
              <div className="absolute inset-0.5 rounded-full bg-violet-500/10 flex items-center justify-center">
                <Cpu className="w-3 h-3 text-violet-400" />
              </div>
            </div>
            <div className="flex items-center gap-2">
              <span className="text-sm font-bold text-white tracking-tight">NEXUS OS</span>
              ...
              <span className="text-[11px] text-white/30 hidden sm:inline">Sistema Operacional Empresarial Autônomo</span>
            </div>
          </div>
          <div className="flex items-center gap-2 text-[10px] text-white/30">
            <span className="hidden sm:inline">9 agentes · IA ativa 24/7</span>
            <ChevronRight className="w-3.5 h-3.5 group-hover:text-violet-400 transition-colors" />
          </div>
        </Link>
